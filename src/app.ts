...
import { adminSmPlanningRouter, smPlanningRouter } from "./routes/sm-planning.js";
...
function createApp() {
  ...
  app.use("/admin/kurti", adminKurtiRouter);
  ...
  app.use("/admin/sm-planning", adminSmPlanningRouter);
  app.use("/admin/sm-activity", adminSmActivityRouter);
